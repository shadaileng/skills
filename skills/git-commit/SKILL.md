...
name: git-commit
description: >
  Git commit conventions for software projects.
...
- `scope` 为可选的模块/功能范围，如 `auth`、`api`、`ui` 等
...
`feat`/`fix` 提交后可自动更新版本号，通过 `--amend` 合并：
